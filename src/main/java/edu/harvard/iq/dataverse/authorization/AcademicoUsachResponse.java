 ...
 * @author michael
 */
public class AcademicoUsachResponse {
    ...
    private String codigoUnidadMayorContrato;
    ...
    public String getCodigoUnidadMayorContrato() {
        return codigoUnidadMayorContrato;
    }

    public void setCodigoUnidadMayorContrato(String codigoUnidadMayorContrato) {
